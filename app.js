...
console.log("Hi " + usersName + " welcome to my page!" + " I love " + usersFavoriteAnimal + "s" + "too!");
document.write("Hi " + usersName + " welcome to my page!" + " I love " + usersFavoriteAnimal + "s" + " too!");
